...
const UpdateAdminDetails = () => {
    ...
    const loadData = async () => {
        ...
        try {
            ...
            setAdminDetails(a => ({ ...a, userDetails: { ...a.userDetails, ...prevData.userDetails, address: { ...a.userDetails.address, ...prevData.userDetails.address } } }));
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await AdminService.updateAdmin(adminId, adminDetails);
            alert(res.data.message);
            Navigate('/admindashboard');
        } catch (error) {
            alert("Failed in Updating Admin Details" + error);
        }
    };
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-8 col-lg-6 bg-dark text-light my-1 p-4 pt-3 rounded">
                            <form onSubmit={handleSubmit}>
                                <h2 className="mb-4 text-center">Update Admin Details</h2>
                                ...
                                <div className="row mb-3">
                                    <div className="col-md-6">
                                        ...
                                        <input type="email" className="form-control" name="email" value={adminDetails.email} readOnly />
                                    </div>
                                    <div className="col-md-6">
